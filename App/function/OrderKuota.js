...
class OrderKuota {
    constructor() {
        this.apikey = "echa"; // API Key sesuai dengan parameter API baru
    ...
    async createPayment(amount) {
        try {
            const url = `https://ruztan.apixd.my.id/api/orkut/createpayment?apikey=${this.apikey}&amount=${amount}&codeqr=${this.codeqr}`;
    ...
    async cekStatus() {
        try {
            const url = `https://ruztan.apixd.my.id/api/orkut/cekstatus?apikey=${this.apikey}&merchant=${this.merchantId}&keyorkut=${this.apiToken}`;
            const response = await axios.get(url);
